...
public class HelicalFusionRenderer extends DynamicRender<FusionReactorMachine, HelicalFusionRenderer> {
    ...
    public void render(FusionReactorMachine machine, float partialTick,
        ...
        if (distSq < LOD_NEAR * LOD_NEAR) {
            segments = 400; crossSections = 12;
        } else if (distSq < LOD_MID * LOD_MID) {
            segments = 260; crossSections = 10;
        } else {
            segments = 160; crossSections = 8;
        }
    ...
    @Override public boolean shouldRenderOffScreen(FusionReactorMachine m) { return true; }
    @Override public int getViewDistance() { return 128; }
    @Override public @NotNull AABB getRenderBoundingBox(FusionReactorMachine m) {
